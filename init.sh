...
# Let Nginx serve the docker containers running on port 8000, 8089 instead of a static web page
sed -i 's|root /var/www/html;|$locust_conf\n$otree_conf|' "$nginx_conf"
